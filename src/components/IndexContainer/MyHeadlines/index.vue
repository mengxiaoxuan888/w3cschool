<template>
  <div class="headlines">
    ...
    <a class="fr headlines-more" href="//www.w3cschool.cn/article" target="_blank" title="查看更多">
      <i class="i-icon i-icon-more"></i>
    </a>
    <ul class="headlines-list">
      <li v-for="item in headlinesList" :key="item.id">
        <span class="fr headlines-time">{{item.time}}</span>
